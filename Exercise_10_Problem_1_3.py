...
geodata = geodata.to_crs(espg=32634)
...
# YOUR CODE HERE 9
add_fp =r"data/500m_mesh_suikei_2018_shape_13/500m_mesh_2018_13.500m_mesh_2018_13.shp"

pop = gpd.read_file(add_fp)
...
# YOUR ANSWER HERE
it was difficult to find the answer from the data
# Well done!
